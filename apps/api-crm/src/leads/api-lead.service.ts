...
export class ApiLeadService {
  ...
  async updateLead(id: string, dto: UpdateLeadDto): Promise<{ updated: boolean, updatedCount: number }> {
  ...
  async deleteLead(id: string): Promise<{ deleted: boolean, deletedCount: number }> {
